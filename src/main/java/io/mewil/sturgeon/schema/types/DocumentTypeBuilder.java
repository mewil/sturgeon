...
public class DocumentTypeBuilder extends TypeBuilder {
  ...
  public GraphQLObjectType build() {
    return new GraphQLObjectType.Builder()
        ...
        .fields(
            buildFieldDefinitionsFromIndexMapping(indexMapping.getKey(), indexMapping.getValue()))
        .build();
  }

  private List<GraphQLFieldDefinition> buildFieldDefinitionsFromIndexMapping(
      String index, Map<String, Object> mapping) {
